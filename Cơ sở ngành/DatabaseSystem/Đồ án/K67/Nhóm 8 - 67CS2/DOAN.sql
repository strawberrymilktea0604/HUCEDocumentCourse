...
--- Cho biết các phòng hạng Standard có 2 giường đơn còn trống
SELECT P.SoPhong, HP.TenHangPhong, LP.TenLoaiPhong, P.TrangThai FROM PHONG P JOIN LOAI_PHONG LP ON P.MaLoaiPhong = LP.MaLoaiPhong JOIN HANG_PHONG HP ON P.MaHangPhong = HP.MaHangPhong
WHERE HP.TenHangPhong = 'Standard' AND LP.TenLoaiPhong = N'2 giường đơn' AND P.TrangThai = N'Trống'
...
SELECT PDP.MaPhieuDP, PBTTH.MaPhieuBTTH, CT.MaTN, CT.SoLuong, CT.DVTinh
FROM PHIEU_DAT_PHONG PDP JOIN PHIEU_BOI_THUONG_THIET_HAI PBTTH ON PDP.MaPhieuDP = PBTTH.MaPhieuDP JOIN CHI_TIET_BOI_THUONG_THIET_HAI CT ON PBTTH.MaPhieuBTTH = CT.MaPhieuBTTH;
...
INSERT INTO NHAN_VIEN(MaNV, HoTen, CCCD, GioiTinh, SDT, Email, DiaChi, NgayVao)
VALUES 
	('NV011', N'Nguyễn Anh Hào', '004574630123', 1, '0901207537', 'mikehao@gmail.com', N'Thái Nguyên', '01/19/2024');

--- Liệt kê các nhân viên Nam vào làm sau 05/01/2024
SELECT * FROM NHAN_VIEN
...
UPDATE KHACH_HANG
SET TenKH = N'Nguyễn Văn Minh'
WHERE SDT = '0968452917'

SELECT* FROM KHACH_HANG

DELETE FROM KHACH_HANG WHERE MaKH = 'KH00000010'