...
CREATE TABLE `invoice` (
  ...
  KEY `emp_id` (`emp_id`),
  KEY `cus_id` (`cus_id`),
  KEY `invoice_ibfk_3` (`store_id`),
  KEY `invoice_ibfk_4` (`dis_id`),
  ...
  CONSTRAINT `invoice_ibfk_3` FOREIGN KEY (`store_id`) REFERENCES `store` (`store_id`),
  CONSTRAINT `invoice_ibfk_4` FOREIGN KEY (`dis_id`) REFERENCES `discount` (`dis_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-05-24  1:55:51
